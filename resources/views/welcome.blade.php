        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo" style="color: rgb(233, 0, 0) !important;">Sentinel Scan</a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav" style="color: white !important;">
                            ...
                            <li><a data-toggle="modal" data-target="#signUpModal"
                                    class="cursorPoint decorationNone">Signup</a></li>
                            <li><a data-toggle="modal" data-target="#loginModal"
                                    class="cursorPoint decorationNone">Login</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <h1>Welcome to <strong>Sentinel Scan</strong></h1>
                        <p>Unlocking Cybersecurity Excellence</p>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <br>
                        <br>
                        <img style="margin-top: 30px" src="assets/images/slider-icon.png"
            ...
            <div class="row">
                ...
                <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                    <div class="left-heading">
                        <h5>Sentinel Scan: Pioneering Cybersecurity Solutions</h5>
                    </div>
                    <div class="left-text">
                        <p>Your On-the-Fly Malware Detection Partner. Sentinel Scan may be new on the scene, but our
                            ...
                            secure. With Sentinel Scan, you can browse and work with confidence, knowing that our
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input required class="form-control" type="email" name="email"
                                        id="un" placeholder="Email" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <input required class="form-control" type="password" name="password"
                                        id="pw" placeholder="Password" autocomplete="off">
                                </div>
                                <div class="form-group">
